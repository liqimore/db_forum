package com.codefog.controller;

import com.codefog.domain.Reply;
import com.codefog.domain.Tab;
import com.codefog.domain.Topic;
import com.codefog.domain.User;
import com.codefog.service.impl.ReplyServiceImpl;
import com.codefog.service.impl.TabServiceImpl;
import com.codefog.service.impl.TopicServiceImpl;
import com.codefog.service.impl.UserServiceImpl;
...
public class TopicController {
    ...
    @RequestMapping("/topic/del/{id}")
    public ModelAndView delTopic (@PathVariable("id")Integer id, HttpSession session) {
